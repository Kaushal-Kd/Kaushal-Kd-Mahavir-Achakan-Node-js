...
const BookingDraftActions = ({
  ...
  const handleSaveDraft = useCallback(() => {
    ...
    navigate('/booking/new', { state: { manualSaveDraft: Date.now() } });
  ...
  const handleNewDraft = useCallback(() => {
    ...
    navigate('/booking/new', { state: { startNewDraft: Date.now() } });
  ...
  return (
    <>
      ...
      <Modal
        ...
        title="Booking drafts (this device)"
        size="md"
        footer={
      ...
      >
        <p className="text-xs text-gray-600 mb-2 leading-snug">
          Drafts are stored in this browser only. Submitting a booking clears the active draft. Use{' '}
          <span className="font-medium text-gray-800">New draft</span> to save what you have here and start another
...
export default BookingDraftActions;
